...
\cliente{Área de atención al cliente}
\empresaCliente{Ualá}
...
\begin{itemize}
	\item Enviar y recibir plata desde cualquier cuenta bancaria.
...
Impulsor      & Nicolás Dagosta   & \empclientename            & Gerente de Machine Learning       	\\ \hline
...
%\begin{consigna}{red}
El propósito de este proyecto es: optimizar el tiempo que lleva el proceso de resolución de reclamos y consultas, mediante su clasificación automática; y por otro lado, reducir la cantidad de personas necesarias para realizar esta tarea, de manera tal que puedan enfocarse en el proceso de resolución.
%\end{consigna}
